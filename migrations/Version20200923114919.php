 ...
 */
final class Version20200923114919 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD organizer INT NOT NULL, DROP organizer_id, DROP location_num_location');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD location_num_location INT NOT NULL, CHANGE organizer organizer_id INT NOT NULL');
